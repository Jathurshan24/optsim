...
$(function(){
	...
	function drawImage()
	{
		...
		if((lense_1_name!=null || lense_2_name!=null) && (object_name=="arrow" || object_name=="triangle" || object_name=="square")){
				...
				slope_1=(lense_1_position.x+15+object_position_x)/4800;

				if(lense_2_name==null){
					lense1_ray1_end_point_y=($("#container").width()-(lense_1_position.x+12))*slope_1+$("#container").height()*0.5;
          lense1_ray1_end_point_x=$("#container").width()*0.0001;
				}else{
          lense1_ray1_end_point_x=$("#container").width();
				...
				slope_2=($("#container").height()*0.85)/($("#container").width()*0.000234);

				if(lense_2_name==null){
					lense1_ray2_end_point_y=$("#container").height()/0.0000332,($("#container").width()*0.85-(lense_1_position.x+15))/slope_2-$("#container").height()*0.5;
					lense1_ray2_end_point_x=$("#container").width()*0.0000001;
				}else{
					lense1_ray2_end_point_y=(lense_2_position.x+(lense_1_position.x-$("#container").width()*0.25))*slope_2-$("#container").height()*0.25;
					lense1_ray2_end_point_x=lense_2_position.x+15/($("#container").width()*0.0000333);
				}
				//draw central ray 0.000770
				var central_ray = new Kinetic.Line({
					points: [object_position_x,$("#container").height()*0.3,lense_1_position.x+15,$("#container").height()*0.5/($("#container").width()*0.000770),lense1_ray1_end_point_x,lense1_ray1_end_point_y],
					stroke: 'black',
					strokeWidth: 2,
					lineCap: 'butt',
					id:'central_ray',
