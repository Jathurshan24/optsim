...
$(function(){
		...
		var imageCount = -1;
		var imageSrc = [
			"triangle1.png","concave.png","mirror1.png"
	...
	function drawImage()
	{
		...
		if((lense_1_name!=null || lense_2_name!=null) && (object_name=="arrow" || object_name=="triangle" || object_name=="square")){
				...
				slope_1=(lense_1_position.x+60+object_position_x)/4800;

				if(lense_2_name==null){
					lense1_ray1_end_point_y=($("#container").width()-(lense_1_position.x+60))*slope_1+$("#container").height()*0.5;
          ...
          lense1_ray1_end_point_x=$("#container").width();
				...
				var central_ray = new Kinetic.Line({
					points: [object_position_x,$("#container").height()*0,lense_1_position.x+60,$("#container").height()*2.0/($("#container").width()*0.0000),lense1_ray1_end_point_x,lense1_ray1_end_point_y],
					stroke: 'black',
					strokeWidth: 2,
					lineCap: 'butt',
					id:'central_ray',
				...
				var incident_ray = new Kinetic.Line({
					points: [object_position_x,$("#container").height()*0.3,lense_1_position.x+60,$("#container").height()*0.3],
					stroke: 'black',
					strokeWidth: 2,
					lineCap: 'butt',
					id:'incident_ray',
			...
			if(lense_1_name=="convex_lense" || lense_1_name=="plano_convex_lense" || lense_1_name=="meniscus_lense"){	//do if the dropped lense is Convex Lense
					...
					var refracted_ray_convex = new Kinetic.Line({
							points: [lense_1_position.x+55,$("#container").height()*0.3,lense1_ray2_end_point_x,lense1_ray2_end_point_y],
							stroke: 'green',
							strokeWidth: 2,
							lineCap: 'butt',
