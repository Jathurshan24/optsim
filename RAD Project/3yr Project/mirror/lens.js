...
$(function(){
	...
	function drawImage()
	{
		...
		if((lense_1_name!=null || lense_2_name!=null) && (object_name=="arrow" || object_name=="triangle" || object_name=="square")){
				...
				slope_1=($("#container").height()*0.3)/(lense_1_position.x+0.003-object_position_x)*($("#container").width()*0.0002);
				...
				//find slope between principal axis and the ray go through the focal point (principle axis going to f)
				slope_2=($("#container").height()*0.2)/($("#container").width()*0.038);
				...
				var central_ray = new Kinetic.Line({
					points: [object_position_x,$("#container").height()*0.3,focal_point_lense_1,$("#container").height()*0.5,-lense1_ray1_end_point_x,lense1_ray1_end_point_y],
					stroke: 'black',
					strokeWidth: 2,
					lineCap: 'butt',
					id:'central_ray',
